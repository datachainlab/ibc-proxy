...
// Profile with:
// /usr/local/go/bin/go test -benchmem -run=^$ github.com/datachainlab/ibc-proxy/testing/simapp -bench ^BenchmarkFullAppSimulation$ -Commit=true -cpuprofile cpu.out
