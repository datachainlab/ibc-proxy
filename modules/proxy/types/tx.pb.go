...
type MsgProxyConnectionOpenTry struct {
	...
	ProxyConsensusState      *types1.Any          `protobuf:"bytes,7,opt,name=proxy_consensus_state,json=proxyConsensusState,proto3" json:"proxy_consensus_state,omitempty"`
	...
	ProofProxyClient         []byte               `protobuf:"bytes,13,opt,name=proof_proxy_client,json=proofProxyClient,proto3" json:"proof_proxy_client,omitempty"`
	ProofProxyConsensus      []byte               `protobuf:"bytes,14,opt,name=proof_proxy_consensus,json=proofProxyConsensus,proto3" json:"proof_proxy_consensus,omitempty"`
	ProofProxyHeight         types2.Height        `protobuf:"bytes,15,opt,name=proof_proxy_height,json=proofProxyHeight,proto3" json:"proof_proxy_height"`
	ProxyConsensusHeight     types2.Height        `protobuf:"bytes,16,opt,name=proxy_consensus_height,json=proxyConsensusHeight,proto3" json:"proxy_consensus_height"`
	Signer                   string               `protobuf:"bytes,17,opt,name=signer,proto3" json:"signer,omitempty"`
}
...
var fileDescriptor_68797dc99f8f4cd2 = []byte{
	...
	,
}
...
func (m *MsgProxyConnectionOpenTry) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			...
			if m.ProxyConsensusState == nil {
				m.ProxyConsensusState = &types1.Any{}
			}
